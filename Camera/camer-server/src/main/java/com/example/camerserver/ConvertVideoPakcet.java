...
public class ConvertVideoPakcet {
    ...
    public static Boolean start(String deviceId, final String formUrl, final String toUrl){
...
//        InputStream inputStream = new FileInputStream(new File("E:\\QLDownload\\tou\\tou.flv"));
        ...
        System.out.println(formatContext);
...
//                .rtmp("rtmp://192.168.1.115/live/ch01").start();
    }
}
